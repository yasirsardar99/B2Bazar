      ...
      <div className="col-12 col-md-8 col-lg-6 col-xl-5">
        <div className="card log-card  shadow" >
          <div className="card-body p-3 text-center">
            ...
            <h1 className="signup-head mb-4"><b>Sign Up</b></h1>
            ...
            <div className='d-flex justify-cntent-between'>
              ...
              <input type="text" id="typeName" className="form-control form-control-lg" value={name} onChange={(e)=>setPassword(e.target.value)} autoComplete='current-name'  required/>
                ...
                <div className=''>
                <label className="form-label  d-flex justify-content-left" for="typePasswordX-2" style={{color: "#002549"}} ><b>last Name:</b></label>
              <input type="text" id="typeName" className="form-control form-control-lg"  autoComplete='current-name'  required/>
                </div>
            </div>
            ...
            <div className="form-outline mb-3 ">
            <label for="typeNumber"  className="form-label d-flex justify-content-left"  style={{color: "#002549"}}><b>Mobile Number:</b></label>
              <input type="number" id='typeNumber' className="form-control  form-control-lg"   autoComplete='current-Number' required/>
            ...
            <button className="btn btn-lg btn-block btn-primary mb-2" 
              ...
              <div className='d-flex '>
                ...
                <Link to="/Login" className='mx-2' style={{color: "#002549"}}>Log In</Link>
              </div>
